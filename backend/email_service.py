...
class EmailService:
    ...
    def send_email(
        ...
        try:
            ...
            msg['From'] = f"Sunny Sioux Care <{self.from_email}>"
            msg['To'] = to_email
            msg['Subject'] = subject
...
{self.admin_email}
        ...
        <body style="font-family: Arial, sans-serif; color: #333; max-width: 600px; margin: 0 auto;">
            ...
            <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 8px 8px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                ...
                <p style="color: #64748b;">If you have any questions, please contact us at 
                   <a href="mailto:{self.admin_email}" style="color: #f97316;">{self.admin_email}</a>
                </p>
